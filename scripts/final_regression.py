...
ADMIN_USER = os.getenv("VF_REG_ADMIN_USER", "codex_reg_admin")
ADMIN_PASS = os.getenv("VF_REG_ADMIN_PASS", "Codex123!")
NORMAL_USER = os.getenv("VF_REG_USER", "codex_reg_user")
...
def main():
    ...
    expect("返回用户工作台" not in admin_html, "/admin still contains removed back-to-workspace action")

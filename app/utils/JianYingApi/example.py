...
from . import Drafts, Jy_Warp


def main():
    d = Drafts.Create_New_Drafts(r"E:\SB\JianyingPro Drafts/PulpFiction")
    ...
    d.Content.Add2Track(
        ...
        Content={
            ...
            "visible": True,
            "volume": 1,
            "source_timerange": {"duration": 605000000, "start": 2050633333},
    ...
    d.Content.AddMaterial(
        ...
        Content={
            ...
            "name": effect_name,
            "render_index": 0,
            "effect_resource_id": effect_resource_id,
            "type": "video_effect",
            "value": 1,
        },
    )
    d.Content.Add2Track(
        Track_id=efect_track["id"],
        Content={
            "id": effect_track_id,
            "material_id": effect_material_id,
            "render_index": 11000,
            "speed": 1,
            "target_timerange": {"duration": 500600000, "start": 0},
            "visible": True,
            "volume": 1,
        },
    )
    d.Save()
    return Jy_Warp.Instance(JianYing_Exe_Path=r"E:\SB\JianyingPro")
